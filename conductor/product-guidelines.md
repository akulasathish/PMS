...
## Design Aesthetic
- **Accessible Operations:** Utilitarian, accessibility-first design for efficient hotel operations across all three tiers.
...
## UX Principles
- **Role Isolation UX:** Ensure strict role-based views with zero "tier bleed," keeping the user's interface focused on their specific operational responsibilities.
