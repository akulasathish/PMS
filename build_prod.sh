...
echo "=== Step 0: Authenticating Docker with AWS ECR ==="
aws ecr get-login-password --region ap-south-1 | docker login --username AWS --password-stdin 401644592968.dkr.ecr.ap-south-1.amazonaws.com
