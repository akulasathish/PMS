...
export function getSupabaseAdmin() {
  ...
  console.log('DEBUG: Raw NEXT_PUBLIC_SUPABASE_URL in getSupabaseAdmin:', process.env.NEXT_PUBLIC_SUPABASE_URL);
  console.log('DEBUG: Raw SUPABASE_SERVICE_ROLE_KEY in getSupabaseAdmin:', process.env.SUPABASE_SERVICE_ROLE_KEY);
